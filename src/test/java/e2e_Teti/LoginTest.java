...
import e2e_Teti.pages.HomeblogPage;
import e2e_Teti.pages.LoginPage;
import e2e_Teti.pages.ProfilePage;
...
public class LoginTest extends BaseTest {
    ...
    public void userCanLoginEmptyEmail() {
        loginTestMethod("", "123456Start", "login_without_email", true);
    }

    @Test
    public void userCanLoginWithEmptyPassword() {
        loginTestMethod("tatyanaskv@rambler.ru", "", "login_without_password", true);
    }
