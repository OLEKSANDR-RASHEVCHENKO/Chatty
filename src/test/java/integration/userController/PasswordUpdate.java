package integration.userController;
...
public class PasswordUpdate extends ApiBase {
    ...
    public String changePassword(String userId, PasswordUpdateReq passwordReq, int expectedStatusCode) throws JsonProcessingException {
